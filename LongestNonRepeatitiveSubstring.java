...
public class LongestNonRepeatitiveSubstring {
    public static int lengthOfLongestSubstring(String s) {
        ...
        while(i < s.length()) {
            ...
            // chacking if the previous value is duplicate value
            ...
            // last possible place where duplicate value can be is between start and i
            else {
                if(max < map.size()) max = map.size();
